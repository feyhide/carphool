    ...
    >
      <div className="flex gap-2 w-fit">
        ...
        <div className="flex w-fit items-start flex-col">
          <div className="flex gap-2 w-fit ">
            ...
            <p className="text-center">{ride.pickUpPoint}</p>
          </div>
          <div className="flex w-fit gap-2">
            <img src="/icons/location.png" className="w-5" />
            <p className="text-center">{ride.destinationPoint}</p>
          </div>
        </div>
      </div>
      <div className="w-full flex gap-2">
        <div className="w-full flex gap-2 items-center">
          ...
          <p className="w-full truncate text-sm">{ride.vehicle.name}</p>
        </div>
      </div>
      <div className="w-full flex gap-2">
        <div className="w-full flex gap-2 items-center">
      ...
      <div className="w-full flex gap-2">
        <div className="w-full flex gap-2 items-center">
          ...
          <p className="w-full truncate text-sm">
            {ride.price.currency} {ride.price.amount} / person
          </p>
        </div>
      </div>
      <div className="w-full flex gap-2">
